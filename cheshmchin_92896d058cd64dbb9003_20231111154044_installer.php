...
class BootstrapRunner
{
    ...
    public function getMainInstallerUrlData()
    {
        ...
        if (self::isBridgeInstall()) {
            ...
            $data['brchk']          = BootstrapUtils::getBridgeHash();
        }
        return $data;
    }
...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = 'cheshmchin_92896d058cd64dbb9003_20231111154044_archive.zip';
        const ARCHIVE_SIZE           = '134349334';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = '92896d0-11154044';
        const SECONDARY_PACKAGE_HASH = '0c41b1a-11154044';
